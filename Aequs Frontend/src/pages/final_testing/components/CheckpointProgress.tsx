    ...
    <div className="mb-6">
      ...
      <div className="mb-4">
        <div className="flex justify-between text-sm text-gray-600 mb-2">
          ...
          <span>
            {getCompletedCount()} of {getTotalCheckpoints()} checkpoints
            completed
          </span>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between text-sm text-gray-600 mb-2">
                <span>Progress</span>
                <span>
                  {Math.min(currentIndex, totalForPart)}/{totalForPart}
                </span>
              </div>
              <div className="w-full bg-gray-100 rounded-full h-2 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(Math.min(currentIndex, totalForPart) / totalForPart) * 100}%`,
                  }}
                ></div>
              </div>
              <div className="mt-2 text-xs text-gray-500">
                Status:{" "}
                {currentIndex >= totalForPart
                  ? "Completed"
                  : isFailed
                    ? "Failed"
                    : "In Progress"}
