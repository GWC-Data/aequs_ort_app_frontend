...
const normalizeDto = (dto: ChamberLoadDto): ChamberLoad => {
  const machineDescription = dto.machineDescription || dto.machineDetails?.machineDescription || dto.chamber;
  const machineDetails = {
    ...(dto.machineDetails || {}),
    machineDescription,
    machineId: dto.machineId || dto.chamber || (dto.machineDetails as any)?.machineId,
  };
