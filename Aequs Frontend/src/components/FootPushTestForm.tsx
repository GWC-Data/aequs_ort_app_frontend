...
interface FootPushOutFormProps {
  formData: FormData;
...
export default function FootPushOutForm({ 
  formData, 
  updateFormField, 
  updateRowField, 
  addRow 
}: FootPushOutFormProps) {
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="max-w-full mx-auto">
        <h2 className="text-3xl font-bold text-gray-900 mb-8">Foot Push Test Form</h2>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-300">
                  ...
                  <th className="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap">Foot#</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {formData.rows.map((row, index) => (
                  <tr key={row.id} className={index % 2 === 0 ? "bg-white hover:bg-gray-50" : "bg-gray-50 hover:bg-gray-100"}>
                    ...
                    <td className="px-4 py-4">
                      <input value={row.footNumber} readOnly className="w-full min-w-[100px] px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-600 font-medium" />
                    </td>
                    <td className="px-4 py-4">
                      <select
                        value={row.visual}
