...
//   // Auto-focus input when scanner is active and test is started
//   useEffect(() => {
//     if (
//       isScannerActive &&
//       selectedTestAggregated &&
...
//       // Ignore if user is typing in input manually
...
//           // Trigger scan automatically if conditions are met
//           if (
//             !scanning &&
//             selectedTestAggregated &&
//             testStarted &&
...
//             } ${isInputDisabled ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-200"}`}
//           >
//             {isScannerActive ? (
//               <>
...
//                   : isScannerActive
//                     ? "Scan barcode or type part number..."
...
//             } ${isScannerActive ? "border-green-300 ring-1 ring-green-200" : ""}`}
//           />
//           {isScannerActive && (
//             <div className="absolute -top-2 right-2">
//               <div className="flex items-center gap-1 px-2 py-0.5 bg-green-100 text-green-800 text-xs rounded-full border border-green-300">
...
//           } ${isScannerActive ? "ring-1 ring-green-200" : ""}`}
//         >
//           {scanning ? (
...
//                   : isScannerActive
//                     ? "Keep cursor in input field or scan barcodes directly"
...
//               type="button"
//               onClick={toggleScanner}
//               className="flex items-center gap-1 px-2 py-1 text-xs bg-red-100 text-red-700 rounded border border-red-300 hover:bg-red-200 transition-colors"
//             >
